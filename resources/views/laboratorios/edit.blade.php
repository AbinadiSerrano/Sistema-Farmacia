                        ...
                        <div class="row padding-1 p-1">
                            <div class="col-md-12">
                                ...
                                <div class="form-group mb-2 mb20">
                                    ...
                                    <input type="text" name="nombre" class="form-control" value="{{ old('nombre', $laboratorio?->nombre) }}" style="max-width: 500px;"id="nombre">
                                    ...
                                    <input type="text" name="direccion" class="form-control" value="{{ old('direccion', $laboratorio?->direccion) }}" style="max-width: 500px;"id="direccion">
                                ...
                                <div class="form-group mb-2 mb20">
                                    ...
                                    <input type="email" name="correo" class="form-control" value="{{ old('correo', $laboratorio?->correo) }}" style="max-width: 500px;"id="correo">
                                ...
                                <div class="form-group mb-2 mb20">
                                    ...
                                    <input type="number" name="telefono" class="form-control" value="{{ old('telefono', $laboratorio?->telefono) }}" style="max-width: 500px;"id="telefono">
                                ...
                                <div class="form-group mb-2 mb20">
                                    ...
                                    <input type="text" name="pais" class="form-control" value="{{ old('pais', $laboratorio?->pais) }}" style="max-width: 500px;"id="pais">
                                    @if ($errors->has('pais'))
                                ...
                                <div class="form-group mb-2 mb20">
                                    ...
                                    <input type="text" name="ciudad" class="form-control" value="{{ old('ciudad', $laboratorio?->ciudad) }}" style="max-width: 500px;"id="ciudad">
